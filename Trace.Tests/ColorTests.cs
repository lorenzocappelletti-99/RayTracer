...
public class ColorTests
{
    ...
    public void TestColorAddition()
    {
        ...
        Assert.True(Color.are_close_colors(expected, result), $"ColorAddition doesn't work properly.");
    }
    ...
    public void TestColorMultiplication()
    {
        ...
        Assert.True(Color.are_close_colors(expected, result), $"ColorMultiplication doesn't work properly");
    }
    ...
    public void TestColorScalarMultiplication()
    {
        ...
        Assert.True(Color.are_close_colors(expected, result), $"ColorScalarMultiplication doesn't work properly.");
    }
    ...
    public void TestColorCloseness()
    {
        ...
        Assert.True(result, $"ColorCloseness doesn't work properly.");
    }
}
